      ...
      <div className="flex max-lg:flex-col max-lg:items-center justify-between items-start h-full">
        <div className="flex flex-col mx-8 flex-1 justify-between h-full p-5 gap-5">
          ...
          <div className="text-lg sm:text-2xl text-center ">
            At <span className={" font-potta_one"}>Conacy</span>, we understand
          ...
          <div className="flex max-lg:flex-col flex-row-reverse lg:gap-5 items-center">
            <ScreenshotPhone />
...
const GetStartedButton = () => {
  return (
    <Link
      className="btn sm:btn-block border-none transition-all duration-300 bg-gradient-to-br dark:from-blue-200 dark:to-white from-blue-950 to-sky-700 bg-sky-400 dark:bg-slate-400 bg-size-200 hover:to-black hover:dark:to-white bg-[0%] hover:bg-[100%] flex justify-between "
      to={"/register"}
    >
