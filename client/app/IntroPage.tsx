    ...
    <main className="flex flex-col min-h-screen">
      <div className="navbar sticky flex justify-between items-center px-10 py-5 w-full">
        ...
        <div className="flex items-start">
          <Image src={logo} alt="" className="sm:h-20 sm:w-20 h-16 w-16"></Image>
          <div className={pottaone.className + " sm:text-6xl text-4xl"}>onacy</div>
        </div>
      ...
      <div className="flex max-lg:flex-col max-lg:items-center justify-between items-start h-full">
        <div className="flex flex-col mx-8 flex-1 justify-between h-full p-5 gap-5">
          <div className="text-4xl sm:text-6xl">Where privacy is priority.</div>
              ...
              {features.map((v, i) => (
                ...
                >
                  <div className="flex flex-row items-center">
                    <Image src={v[2]} alt="" className="sm:w-40 sm:h-40 w-28 h-28" />
